...
void init()
{
 ...
 // Load shaders and create a shader program (to be used in display())
    program = InitShader("Shader/vshader42.glsl", "Shader/fshader42.glsl");
	program_particles=InitShader("Shader/vshader_particles.glsl", "Shader/fshader_particles.glsl");
